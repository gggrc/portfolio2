// Nav-bar Date Time Functionality
...
// Initializing Navbar & Scroll Interaction
document.addEventListener("DOMContentLoaded", () => {
  ...
  navLinks.forEach((link) => {
    link.addEventListener("click", function () {
      ...
      if (navMenu) navMenu.classList.remove("show"); // Close responsive dropdown
    });
  });
  ...
  const observer = new IntersectionObserver(
    ...
    { threshold: 0.4 } // Lowered threshold to work seamlessly on smaller screens
  );
...
const experiences = [
  {
    ...
    description: "Assisted and coordinated groups of 20-30 students/parents, ensuring a seamless visit through logistics management, campus tours, and delivery of UPH promotional information.",
  },
  {
    img: "assets/experiences/PEMBEBAS2025.jpg",
    title: "PEMBEBAS UPH 2025",
    subtitle: "Member of Logistics Division - 2025",
    description: "Overseeing all equipment, supplies, and venue arrangements, and coordinating with other divisions to ensure timely fulfillment of needs for a smooth event from start to finish.",
  },
  {
    img: "assets/experiences/TEDxUPH2025.jpg",
    title: "TEDxUPH 2025",
    subtitle: "Member of Event Division - 2025",
    description: "Managing the planning, execution, coordination of TEDxUPH 2025 to ensure each session runs smoothly, with speakers, performers, and technical aspects well-arranged.",
  },
  {
    img: "assets/experiences/IDEA2025.jpg",
    title: "I-DEA 2025",
    subtitle: "Member of Publication and Registration Division - 2025",
    description: "Designing and managing event publicity and participant registration through effective communication, organized systems, and timely information.",
  },
  {
    img: "assets/experiences/IGC2025.png",
    title: "IGC 2025",
    subtitle: "Coordinator of Publication and Registration Division - 2025",
    description: "Coordinating event promotion and registration to ensure clear communication, efficient systems, and a smooth participant experience.",
  },
  {
    img: "assets/experiences/ACS.jpg",
    title: "Informatics Showcase",
    subtitle: "Presenter - 2025",
    description: "Delivering a summary of Informatics student projects and providing a detailed explanation of the systems used, from concept to implementation.",
  },
  {
    img: "assets/experiences/KEYSTONE2024.jpg",
    title: "KEYSTONE 2024",
    subtitle: "Member of Publication Division - 2024",
    description: "Managing event publicity, including promotional materials, social media, information distribution, and maintaining a positive public image.",
  },
  {
    img: "assets/experiences/STAGECREW.jpg",
    title: "Stage Crew UPH Graduation",
    subtitle: "Since 2024 until 2025",
    description: "Supporting stage management, ensuring smooth transitions during performances, and assisting with technical/logistics needs for the graduation ceremony.",
  },
  {
    img: "assets/experiences/FALCON14.jpg",
    title: "Falcon Project 14",
    subtitle: "Member of Escaperoom Division - 2024",
    description: "Responsible for designing the escape room experience, including theme development, layout planning, rule setting, and room setup to create an immersive and engaging environment.",
  },
  {
    img: "assets/experiences/IVILLAGE2024.jpg",
    title: "I-Village 2024",
    subtitle: "Volunteer - 2024",
    description: "Preparing the materials to be presented and guiding participants during the demonstration session to try using the taught application, as an effort to support UMKM in Bencongan Village.",
  },
  {
    img: "assets/experiences/FALCON13.jpg",
    title: "Falcon Project 13",
    subtitle: "Coordinator Decoration Division - 2023",
    description: "Coordinated design and setup of event decor, overseeing theme implementation, spatial arrangement, and ensuring environment aligns with overall concept to create an immersive experience.",
  },
  {
    img: "assets/experiences/IGC2023.jpg",
    title: "IGC 2023",
    subtitle: "Member of Publication and Registration Division - 2023",
    description: "Managed event publicity and registration processes, coordinating communication, promotional materials, and participant enrollment to ensure smooth outreach and seamless attendance.",
  },
  {
    img: "assets/experiences/ITRIP2024.jpg",
    title: "I-Trip 2023",
    subtitle: "Coordinator of Logistic Division - 2023",
    description: "Oversaw logistics coordination for the transport, event, managing equipment, supplies, and timely delivery to ensure smooth operations and support throughout the program.",
  },
];
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (cardsContainer) {
    experiences.forEach((exp) => {
      ...
      card.innerHTML = `
        <img class="card-image" src="${exp.img}" alt="${exp.title}" />
  ...
  // FIXED: Menggunakan data 'experiences' agar tidak memicu ReferenceError
  if (experiencesSection && experiences.length > 0) {
    let bgIndex = 0;
    setInterval(() => {
      bgIndex = (bgIndex + 1) % experiences.length;
      experiencesSection.style.backgroundImage = `url(${experiences[bgIndex].img})`;
    }, 4000); // Diperlama menjadi 4 detik agar transisi lebih smooth
  }
});
...
const projects = [
  {
    ...
    description: "A modern portfolio website highlighting my projects, skills, and experiences, designed for responsiveness, smooth animations, and seamless user navigation.",
    role: "Developer",
  ...
  },
  {
    ...
    description: "An interactive web application that allows users to take, customize, and download their photos directly from the browser. It features real-time camera access, fun filters, and an easy-to-use interface designed for events and personal use.",
    role: "UI/UX Designer and Frontend Developer",
    tech: "Figma, Node.js, Express",
    youtube: "https://www.figma.com/proto/PHlHTfhYNFNdT4Zjfu5b1Z/PROTOTYPE-PHOTOBOOTH?node-id=641-8584",
    image: "assets/projects/Photobooth.jpg",
    github: "https://www.figma.com/proto/PHlHTfhYNFNdT4Zjfu5b1Z/PROTOTYPE-PHOTOBOOTH?node-id=641-8584",
  },
  {
    title: "Website Database GKI Karawaci",
    description: "A comprehensive database system designed for church community management, tracking membership attendance and logistics.",
  ...
  {
    title: "Portfolio",
    description: "A personal portfolio website showcasing experiences, projects, and skills. Built with React and TypeScript, it focuses on responsive design.",
  ...
  {
    title: "Prayer Link",
    description: "PrayerLink is an innovative spiritual app created to strengthen connections through the power of prayer within a secure community platform.",
    role: "Fullstack Developer",
  ...
  {
    title: "KeyToHatch",
    description: "KeytoHatch is a simple, fun, and educational Java-based typing game that challenges your typing speed and accuracy using a custom Swing GUI.",
  ...
  },
  {
    ...
    description: "An HTML visualizer for sorting, searching, and pathfinding with step-by-step animations, speed controls, and responsive UI.",
    role: "Developer",
    tech: "HTML",
  ...
  {
    title: "Random Dice",
    description: "A simple web app that generates random dice rolls with a click, featuring a clean interface and responsive design.",
    role: "Developer",
  ...
  },
  {
    ...
    description: "Learning Flexbox by building a responsive webpage layout with HTML and CSS, demonstrating various alignment techniques.",
    role: "Developer",
    tech: "HTML, CSS",
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderMain(index) {
    if (!projects[index] || !mainImg) return;
